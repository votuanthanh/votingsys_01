...
*------------------------------------------------------------*/
    ...
    'label' => [
        ...
        'location' => 'Location',
        'time_close' => 'Time for closing poll',
        ...
        'setting' => [
            ...
            'custom_link' => 'Edit link',
            'set_limit' => 'Set the maximum votes',
            'set_password' => 'Set password',
            'show_password' => 'Show password',
            'password_poll' => 'Password of poll: ',
            'is_set_ip' => 'A computer only vote once',
        ],
        'step_4' => 'Participant',
    ...
    'placeholder' => [
        ...
        'number_add' => 'Enter a number to be added',
    ...
    'message' => [
        'create_success' => 'Create poll SUCCESSFULLY',
        'create_fail' => 'Create poll FAIL',
        'upload_image_fail' => 'Can't upload image of option',
        'send_mail_fail' => 'Can't send email to invite other people.',
        'confirm_delete' => 'Are you sure to want to delete this poll?',
        'confirm_delete_option' => 'Are you sure to want to delete this option. It will remove all votes of option?',
        'link_exists' => 'Link existed in system. Please enter a new link',
        ...
        'update_poll_info_success' => 'Update information of poll SUCCESSFULLY',
        ...
        'update_setting_success' => 'Update setting of poll SUCCESSFULLY',
        'update_setting_fail' => 'Update setting of poll FAIL',
        'delete_poll_fail' => 'Delete poll FAIL',
        'delete_poll_success' => 'Delete poll SUCCESSFULLY',
        ...
        'no_poll_participant' => 'User don't participate in poll',
    ...
    'validation' => [
        ...
        'participant' => [
            'email' => 'Please enter email of participant',
        ],
    ],
    'table' => [
        'thead' => [
    ...
    'message_client' => [
        ...
        'time_close_poll' => 'Closing time of poll must be larger than current time',
        'on' => 'ON',
        'off' => 'OFF',
        ...
        'confirm_delete_option' => 'Are you sure to want to delete this option. It will remove all votes of this?',
        'send_email_success' => 'A new email has been sent your email. Please check mail.',
        'send_email_fail' => 'Send email fail, please check your email address.',
        'option_duplicate' => 'Option duplicate. Please enter another',
        'option_minimum' => 'You can't delete this option because a poll must have one answer at least.',
        'option_image_duplicate' => 'Have two same image, are you sure to use it',
        'number_edit' => 'The maximum of votes must be lager than total votes of poll. Number vote of poll is ',
...
*------------------------------------------------------------*/
    ...
    'reopen_poll_successfully' => 'Reopen poll successfully',
    ...
    'voted_poll' => 'You voted this poll successfully',
    ...
    'load_latest_polls' => 'Updated the lasted poll lists',
    'edit_link_admin' => 'Edit Admin link',
    'edit_link_user' => 'Edit User link',
    'participation_link' => 'Participation link',
    'administer_link' => 'Administer link',
    'administration' => 'Administration',
    'vote_empty' => 'Vote empty, You can vote this poll',
    'confirm_delete_vote' => 'Are you sure to delete this vote',
    'email_exist' => 'Email exist, You need to login to vote or chose another',
    ...
    'link_exist' => 'Link existed',
    'link_invalid' => 'Link invalid',
    'edit_link_successfully' => 'Edit successfully',
    'edit_link_admin_successfully' => 'Link managed this poll has been updated. You will be redirected to new link.',
    'delete_all_participants_successfully' => 'Delete all successful participants',
    ...
    'confirm_delete_all_participant' => 'Are you sure to delete all participant of this poll?',
    ...
    'flashy_message' => 'Email has been sent, Please check email',
